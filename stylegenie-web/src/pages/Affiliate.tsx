...
const pricingPlans = [
    ...
    },
    {
        ...
        features: [
            ...
            "Không giới hạn phối đồ mỗi ngày",
    ...
    return (
        <section className="pricing">
            <header className="pricing-header">
                <h3 className="subtitle-gradient">Bảng giá Affiliate</h3>
                <h2 className="pricing-title">Các gói dịch vụ nâng cấp cho Affiliate</h2>
            </header>
